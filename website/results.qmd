...
This section presents qualitative results from the deployed Off-the-Beaten-Path Travel Recommender, using real queries and outputs generated through the live system. Retrieval behavior across models is compared, beginning with a keyword-focused query designed to showcase BM25 performance.
